...
export const LoadingProvider: React.FC<LoadingProviderProps> = ({ children }) => {
  ...
  const [forceHideTimeout, setForceHideTimeout] = useState<NodeJS.Timeout | null>(null);
  ...
  useEffect(() => {
    ...
    window.fetch = async (...args) => {
      ...
      if (typeof url === 'string') {
        if (url.includes('listarObjetos')) loadingMessage = "Cargando objetos...";
        else if (url.includes('listarFuncionalidades')) loadingMessage = "Cargando funcionalidades...";
        else if (url.includes('abmFuncionalidades')) loadingMessage = "Guardando funcionalidad...";
      ...
      const isProjectApi = typeof url === 'string' && (
        url.includes('listar') || 
        url.includes('abm') || 
        url.includes('crear') ||
        url.includes('editar') ||
