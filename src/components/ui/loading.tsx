          ...
          <svg viewBox="0 0 64 64" className="w-full h-full animate-pulse">
            <defs>
              <linearGradient id="shieldGrad" x1="0%" y1="0%" x2="100%" y2="100%">
                ...
                <stop offset="100%" className="stop-color-accent" stopOpacity="0.4"/>
              </linearGradient>
            </defs>
            <path 
      ...
      {text && (
        <div className={cn("mt-4 text-center", textSizeClasses[size])}>
          <div className="flex items-center justify-center gap-2 text-muted-foreground font-medium">
            <svg viewBox="0 0 24 24" className="w-4 h-4 text-primary animate-pulse">
  ...
  return (
    <div className={cn(
      ...
      <div className="absolute inset-0 overflow-hidden">
        <div 
          className="absolute top-0 left-0 w-full h-0.5 bg-gradient-to-r from-transparent via-primary/50 to-transparent animate-scan-vertical"
        />
        <div 
          className="absolute top-0 left-0 h-full w-0.5 bg-gradient-to-b from-transparent via-accent/30 to-transparent animate-scan-horizontal"
        />
      </div>
