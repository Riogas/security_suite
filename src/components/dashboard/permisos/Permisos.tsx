        ...
        <div className="space-x-2">
          {sinMigrar && (
            <Button
              variant="secondary"
              size="sm"
              onClick={() => console.log("Importar permiso", row.original)}
            >
          ...
          <Button
            ...
            onClick={() =>
              router.push(
                `/dashboard/permisos/editar/${row.original?.PermisoId || row.original?.id || ""}`,
              )
            }
          >
          ...
          <Button
            variant="destructive"
            size="sm"
            onClick={() => console.log("Eliminar permiso", row.original)}
          >
